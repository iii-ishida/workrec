...
require 'app/work_service/unfinish'
require 'web/auth'
  ...
  module Works
    class Unfinish
      ...
      def call(work_id, req)
        ...
        App::WorkService::Unfinish.new(@repo).call(params)
      ...
      def new_params(user_id, work_id, req)
        ...
        App::WorkService::Unfinish::Params.new(user_id: user_id, work_id: work_id, time: Time.iso8601(param['time']))
      end
    end
  end
end
