...
extension Model_WorkPb.State: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static var allCases: [Model_WorkPb.State] = [
    .unspecified,
    .unstarted,
    .started,
    .paused,
...
extension Model_WorkPb: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WorkPb"
  ...
  fileprivate class _StorageClass {
    ...
    var _state: Model_WorkPb.State = .unspecified
  ...
  static func ==(lhs: Model_WorkPb, rhs: Model_WorkPb) -> Bool {
...
extension Model_WorkPb.State: SwiftProtobuf._ProtoNameProviding {
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
