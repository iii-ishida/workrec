...
extension WorkrecSchema {
  public class TaskListQuery: GraphQLQuery {
    ...
    public struct Data: WorkrecSchema.SelectionSet {
      ...
      public static var __parentType: ApolloAPI.ParentType { WorkrecSchema.Objects.Query }
      ...
      public struct Tasks: WorkrecSchema.SelectionSet {
        public let __data: DataDict
        public init(data: DataDict) { __data = data }

        public static var __parentType: ApolloAPI.ParentType { WorkrecSchema.Objects.TasksConnection }
        public static var __selections: [ApolloAPI.Selection] {
          [
        ...
        public struct Edge: WorkrecSchema.SelectionSet {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }

          public static var __parentType: ApolloAPI.ParentType { WorkrecSchema.Objects.TaskEdge }
          public static var __selections: [ApolloAPI.Selection] {
            [
          ...
          public struct Node: WorkrecSchema.SelectionSet {
            public let __data: DataDict
            public init(data: DataDict) { __data = data }
        ...
        public struct PageInfo: WorkrecSchema.SelectionSet {
          public let __data: DataDict
          public init(data: DataDict) { __data = data }

          public static var __parentType: ApolloAPI.ParentType { WorkrecSchema.Objects.PageInfo }
          public static var __selections: [ApolloAPI.Selection] {
            [
